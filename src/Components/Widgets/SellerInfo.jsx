            ...
            <CustomCard className={'col-span-2'}>
                ...
                <div className='pt-[20px] '>
                    <div className='flex flex-col gap-3  overflow-hidden text-sm '>
                        ...
                        <div className='flex  justify-between bg-border/50 rounded-md font-[inter] ap-2   py-2 px-3'>
            ...
            <CustomCard className={'col-span-1'} label={'Categories'}>
                <div className='flex flex-col gap-4 max-h-[180px] overflow-auto customScroll pr-2'>
                    {seller?.categories?.map((category, idx) => (
                        <div key={idx} className='flex justify-between items-center bg-border/50 rounded-md font-[inter] py-2 px-3'>
                            <p className='text-sm flex gap-2 items-center text-secondary/90'>{category.name}</p>
            ...
            <CustomCard className={'col-span-1'} label={'Brands'}>
                <div className='flex flex-col gap-4 max-h-[180px] overflow-auto customScroll pr-2'>
                    {seller?.brands?.map((brand, idx) => (
                        <div key={idx} className='flex justify-between items-center bg-border/50 rounded-md font-[inter] py-2 px-3'>
                            <p className='text-sm flex gap-2 items-center text-secondary/90'>{brand.name}</p>
